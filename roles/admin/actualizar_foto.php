<?php
// Iniciar sesión y establecer conexiones necesarias
session_start();
...
// Verificar que existe documento en la sesión (usuario autenticado)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // FUNCIONALIDAD 1: Restablecer imagen de perfil a la predeterminada
    if (isset($_POST['reset_image'])) {
        $default_image = '../usuario/css/img/perfil.jpg'; // Ruta de imagen predeterminada
        
        // Preparar consulta para actualizar la base de datos
        ...
        // Ejecutar actualización y manejar resultado
    ...
    // FUNCIONALIDAD 2: Subir nueva imagen de perfil
    if (isset($_FILES['foto_perfil']) && $_FILES['foto_perfil']['error'] === UPLOAD_ERR_OK) {
        $file = $_FILES['foto_perfil'];
        
        // Configurar directorios de destino
        $upload_dir = realpath(__DIR__ . '/../usuario/css/img/') . '/';
        $relative_dir = '../usuario/css/img/';
        ...
        // Configurar restricciones de archivo
        ...
        // Mover archivo subido a destino final
        if (move_uploaded_file($file['tmp_name'], $destination)) {
            ...
            // Actualizar base de datos con nueva ruta de imagen
